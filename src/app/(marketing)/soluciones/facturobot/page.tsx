                ...
                <AnimationContainer delay={0.1} className="w-full">
                    <div className="flex flex-col items-center justify-center py-10 max-w-xl mx-auto">
                        ...
                        <h1 className="text-2xl md:text-4xl lg:text-5xl font-semibold font-heading text-center mt-6 !leading-tight">
                            Automatiza el procesamiento de facturas con IA.
                        </h1>
                        <p className="text-base md:text-lg mt-6 text-center text-muted-foreground">
                            Simplifica el procesamiento de tus facturas enviandolas por Whatsapp directo a tus sistemas.
                        </p>
                        <div className="flex items-center justify-center gap-x-4 mt-8">
                            <Button size="sm" asChild>
                                <Link href="https://api.whatsapp.com/send?phone=50764523183&text=Estoy%20interesado%20en%20Facturobot!%20%F0%9F%91%8DNecesito%20m%C3%A1s%20informaci%C3%B3n%2C%20por%20favor." target="_blank">
                                    Empieza Gratis
                                </Link>
                            </Button>
